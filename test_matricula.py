...
# MODELO DE DATOS
# =========================================================
# Los cinco campos permiten None para poder probar
# explícitamente los casos de campos obligatorios con null.
